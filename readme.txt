...
nesse card vão estar todos os dados do Avatar digitado junto com a foto selecionada.
Cada card possui um botão de exclusão para caso usuário deseje deletar um determinado Avatar
